...
import 'package:life_pilot/game/steam_scratch_maze/controller_game_steam_scratch_maze_level_generator.dart';
...
class _PageGameSteamScratchMazeState extends State<PageGameSteamScratchMaze> {
  late final ControllerGameSteamScratchMaze game;
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: SizedBox(
                                width: (maxX + 1) * tileSize,
                                height: (maxY + 1) * tileSize,
                                child: WidgetsGameSteamScratchMazeGameBoard(
                                  game: game,
