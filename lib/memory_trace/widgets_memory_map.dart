...
class WidgetsMemoryMap extends StatefulWidget {
  final List<EventItem> events;
  final ControllerEvent controllerEvent;

  const WidgetsMemoryMap({
    super.key,
  ...
  @override
  State<WidgetsMemoryMap> createState() => _WidgetsMemoryMapState();
}

class _WidgetsMemoryMapState extends State<WidgetsMemoryMap> {
